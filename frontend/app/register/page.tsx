...
import { Lock, Mail, User as UserIcon, Loader2, Shield, Sparkles } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-8 shadow-2xl backdrop-blur-xl">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-center text-sm text-zinc-400">
            Register to access support assistant
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="block w-full rounded-lg border border-zinc-850 bg-zinc-950/80 py-3 pl-10 pr-3 text-sm text-zinc-100 outline-none transition-colors duration-200 focus:border-teal-500/80 focus:ring-1 focus:ring-teal-500/30"
                >
